...
ok( copy('t/templates/simple.tmpl', 't/templates/notsosimple.tmpl'),
	"stored simple.tmpl for later restoration");

ok( copy('t/templates/simplemod.tmpl', 't/templates/simple.tmpl'),
...
ok( copy('t/templates/notsosimple.tmpl', 't/templates/simple.tmpl'),
	"able to restore original content of simple.tmpl");
ok( unlink('t/templates/notsosimple.tmpl'),
